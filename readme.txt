=== Super Simple Quotes ===
Contributors: palbrattberg
Tags: super simple quotes, simple ajax quotes, simple ajaxed quotes, simple, simple quotes, simple ajax, quotes, random quotes, quotations, random quote, sidebar, widget, ajax
...
1. Configure what element should contain the quotes (for example `#text-3 .textwidget` for using it in a new text widget) 
1. Add quotes on the Simple Quotes admin panel
